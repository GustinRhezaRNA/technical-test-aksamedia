...
import { ArrowLeft, Save, DollarSign, Calendar, Tag, FileText, TrendingUp, TrendingDown, AlertCircle } from 'lucide-react'
...
const EditTransaction = () => {
  ...
  const { id } = useParams()
  const { getTransaction, updateTransaction, loading: contextLoading } = useTransactions()
  ...
  }, [contextLoading, getTransaction, id])
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-400">Loading transaction...</span>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Transaction Not Found</h1>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Transaction Not Found</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              The transaction you're looking for doesn't exist or may have been deleted.
            </p>
            <Link
              to="/transactions"
